...
<tileset version="1.10" tiledversion="1.11.0" name="B_witch_attack" tilewidth="104" tileheight="46" tilecount="9" columns="1">
 <image source="B_witch_attack.png" width="104" height="414"/>
 <tile id="8">
  <animation>
