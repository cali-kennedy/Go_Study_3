...
<tileset version="1.10" tiledversion="1.11.0" name="pink_shop" tilewidth="64" tileheight="64" tilecount="6" columns="2">
 <image source="pink_shop.png" width="128" height="192"/>
 <tile id="5">
  <animation>
