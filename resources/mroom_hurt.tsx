...
<tileset version="1.10" tiledversion="1.11.0" name="mroom_hurt" tilewidth="32" tileheight="32" tilecount="6" columns="2">
 <image source="mroom_hurt.png" width="64" height="96"/>
 <tile id="5">
  <animation>
