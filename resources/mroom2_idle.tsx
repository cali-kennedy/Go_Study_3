...
<tileset version="1.10" tiledversion="1.11.0" name="mroom2_idle" tilewidth="64" tileheight="64" tilecount="9" columns="1">
 <image source="mroom2_idle.png" width="64" height="576"/>
 <tile id="8">
  <animation>
